...
For this I wanted to look at a wide variety of occupations. I readded the occpation "owner" as there were a number of similarly ambigious occupation titles but I felt if took them all out I might miss some interesting patterns.
...
summary(occs$contbr_occupation)
...
occbyparty$dempercent <- (occbyparty$dem/occbyparty$total)*100

occbyparty$indpercent <- (occbyparty$ind/occbyparty$total)*100

occbyparty$reppercent <- (occbyparty$rep/occbyparty$total)*100
